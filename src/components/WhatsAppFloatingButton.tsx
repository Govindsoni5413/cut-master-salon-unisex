  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-0 inset-x-0 z-40 sm:hidden px-3 pt-2.5 pb-[calc(0.65rem+env(safe-area-inset-bottom,0px))] bg-white/95 backdrop-blur-2xl border-t border-neutral-200/90 shadow-[0_-8px_30px_rgba(0,0,0,0.12)]"
      >
