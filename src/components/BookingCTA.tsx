  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl p-8 sm:p-14 glass-card-3d border border-white/95 text-center overflow-hidden shadow-[0_25px_60px_-15px_rgba(0,0,0,0.08),0_0_0_1px_rgba(229,231,235,0.9),inset_0_1px_2px_rgba(255,255,255,1)]">
