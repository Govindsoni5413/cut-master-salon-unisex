...
export function CategoryNavigation({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto pb-3 pt-2 px-4 sm:px-0 no-scrollbar sm:flex-wrap sm:justify-center scroll-smooth overscroll-x-contain">
        {serviceCategories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 min-h-[44px] px-4.5 sm:px-5 py-2.5 rounded-full text-xs font-bold tracking-wider transition-all duration-300 cursor-pointer select-none active:scale-95 flex items-center ${
                isActive
