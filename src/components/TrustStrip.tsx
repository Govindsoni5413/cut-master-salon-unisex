...
export function TrustStrip() {
  ...
  return (
    ...
    >
      <div className="glass-card-3d rounded-2xl sm:rounded-3xl p-4 sm:p-7 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-8 divide-y lg:divide-y-0 lg:divide-x divide-neutral-200/70">
        {trustPoints.map((item, idx) => {
          ...
          return (
            ...
            >
              <div className="h-9 w-9 sm:h-11 sm:w-11 shrink-0 rounded-2xl bg-neutral-900/5 border border-neutral-200/80 flex items-center justify-center text-neutral-900 shadow-inner">
